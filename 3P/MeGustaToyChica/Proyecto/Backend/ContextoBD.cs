...
public partial class ContextoBD : DbContext
{
	...
	public virtual DbSet<NvlAccInterfaz> NvlAccInterfaces { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
		...
		modelBuilder.Entity<NvlAccInterfaz>(entity =>
		{
		    entity.HasOne(d => d.IdTpoUsuarioNavigation).WithMany(p => p.NvlAccInterfaces).OnDelete(DeleteBehavior.ClientSetNull);
		});

        modelBuilder.Entity<Interfaz>(entity =>
        {
            entity.HasOne(d => d.IdNvlAccInterfazNavigation).WithMany(p => p.Interfaces).OnDelete(DeleteBehavior.ClientSetNull);
        });
